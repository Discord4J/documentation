...
:::note
For a more detailed source of information, please refer to [this section](https://projectreactor.io/docs/core/release/reference/#error.handling) of the Reactor reference guide.
:::
...
We do not recommend the usage of this operator for error handling purposes, we highly recommend replacing instances of `onErrorContinue` with this general pattern:

```java
...flatMap(source -> reactiveOperationThatMightError()
