...
The recommended way to get Discord4J is to use a build automation tool like
[Gradle](https://gradle.org/) or [Maven](https://maven.apache.org/).

Note that we do NOT support users who wish to forgo the use of a dependency manager 
(for example, manually installing Discord4J using a distributed .jar file).
