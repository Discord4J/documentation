...
<img src="/img/interactions/hierarchy.png" />
...
Select menus allow a dropdown to be displayed on a message itself rather than only inside of the command input window.
