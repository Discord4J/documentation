...
This tutorial is up to date with **Discord4J v3.0.x and v3.1.x**. Feel free to provide feedback on it in our [Discord Server](https://discord.gg/d4j) or through a [GitHub issue](https://github.com/Discord4J/Discord4J/issues/new/choose).
